            ...
            <div className="border-b border-[#777777] pb-5 space-y-5">
               <div className="space-y-3">
                <div className="space-y-1">
                    ...
                    <Input placeholder="Enter your name" className="border border-neutral-700"/>
                </div>
                <div className="space-y-1">
                    <Typography styleName="p3" variant="p" weight="medium" className="text-[#242323]">Email</Typography>
                    <Input placeholder="Enter your email" className="border border-neutral-700"/>
                </div>
                <div className="space-y-1">
                    <Typography styleName="p3" variant="p" weight="medium" className="text-[#242323]">Message</Typography>
                    <Textarea placeholder="Enter your message" className="resize-none border border-neutral-700" rows={4}/>
                </div>
            </div>
